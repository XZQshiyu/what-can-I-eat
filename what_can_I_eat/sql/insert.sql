...
insert into dish_reply (reply_id, dish_comment_id, user_id, parent_reply_id, context, publish_time, like_number) values ('rpl001', 'ds_cmt001', '000002', NULL, '我是第一个回复', '20240831', 17);
insert into dish_reply (reply_id, dish_comment_id, user_id, parent_reply_id, context, publish_time, like_number) values ('rpl002', 'ds_cmt001', '000003', 'rpl001', '我是回复的回复', '20240831', 72);